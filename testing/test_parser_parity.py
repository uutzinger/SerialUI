...
def main():
    ...
    header_cases = [
        ...
        ("header/bracketed-units", ["ECG Cal [mV]: 0.000", "ECG Cal [mV]: -0.001"], None),
        ("header/underscore-bracketed-units", ["ECG_Cal_[mV]: 0.303"], None),
        ("header/quoted-name", ["'ECG Cal [mV]': 0.527"], None),
